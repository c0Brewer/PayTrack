...
import { TeamRequestAdminDetailViewComponent } from './detail-component';

describe('TeamRequestAdminDetailViewComponent', () => {
  let component: TeamRequestAdminDetailViewComponent;
  let fixture: ComponentFixture<TeamRequestAdminDetailViewComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [TeamRequestAdminDetailViewComponent],
    }).compileComponents();

    fixture = TestBed.createComponent(TeamRequestAdminDetailViewComponent);
  ...
  it('should render admin-only team and user rows', () => {
    component.request = mockRequest;
    component.loading = false;
    fixture.detectChanges();
    const text = (fixture.nativeElement as HTMLElement).textContent ?? '';
    expect(text).toContain('Chassis Team');
