...
namespace PayTrack.Migrations
{
    ...
    [Migration("20260624203801_FixBudgetTypeUniqueIndex")]
    partial class FixBudgetTypeUniqueIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PayTrack.Data.Entities.Budget", b =>
                {
                    ...
                    b.HasIndex("TeamId", "CostCentreId", "SeasonId", "Type", "PeriodStart", "PeriodEnd")
                        .IsUnique();
