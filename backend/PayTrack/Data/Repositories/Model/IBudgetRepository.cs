...
namespace PayTrack.Data.Repositories.Model
{
    ...
    public interface IBudgetRepository
    {
        ...
        Task<Budget> AddAsync(string name, string? description, int teamId, int costCentreId, int seasonId, decimal targetAmount, DateTime periodStart, DateTime periodEnd);
